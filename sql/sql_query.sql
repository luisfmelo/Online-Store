...
/*Ciência*/
INSERT INTO books VALUES(DEFAULT, 00009, 'Demografia - A Ciência da População', 'J. Manuel Nazareth', 17.99, 1, 'O terreno de jogo é o campo de batalha. Cada partida, um duelo onde aquele que comete menos erros vencerá. Como se organiza uma estratégia para vencer? Qual a táctica que permitirá derrotar o inimigo?', 0);
...
INSERT INTO books VALUES(DEFAULT, 00012, 'O Gene Egoísta', 'Richard Dawkins', 17.69, 1, 'O Gene Egoísta é o primeiro livro de Richard Dawkins, em que ele apresenta uma teoria que procura explicar a evolução das espécies na perspectiva do gene e não do organismo, ou da espécie.', 0);
INSERT INTO books VALUES(DEFAULT, 00013, 'O Erro de Descartes', 'António Damásio', 21.59, 1, 'Em "O Erro de Descartes", obra do neurologista português António Damásio, surge uma nova interpretação acerca do axioma cartesiano cogito, ergo sum. Em vez da plenitude da razão, abre-se espaço para a ética das emoções.', 0);
...
INSERT INTO books VALUES(DEFAULT, 00015, 'A Origem das Espécies', 'Charles Darwin', 21.98, 1, 'A Origem das Espécies, do naturalista britânico Charles Darwin, apresenta a Teoria da Evolução. O nome completo da primeira edição é On the Origin of Species by Means of Natural Selection.', 0);
...
INSERT INTO books VALUES(DEFAULT, 00038, 'O Futuro da Pintura', 'Wassily Kandinsky', 9.54, 5, 'Neste conjunto de ensaios publicados entre 1925 e 1943, Kandinsky expressa o seu pensamento sobre a pintura', 0);
...
INSERT INTO books VALUES(DEFAULT, 00044, 'Lolita', 'Vladimir Nabokov', 11.54, 6, 'Lolita é um romance de Vladimir Nabokov, escrito em inglês e publicado em 1955 em Paris, em 1958 na Cidade de Nova Iorque, e em 1959 em Londres.', 0);
INSERT INTO books VALUES(DEFAULT, 00045, 'Édipo Rei', 'Sófocles', 9.04, 6, 'Édipo Rei é uma peça de teatro grega, em particular uma tragédia, escrita por Sófocles por volta de 427 a.C.. Aristóteles, na sua Poética, considerou esta obra o mais perfeito exemplo de tragédia grega.', 0);
...
INSERT INTO books VALUES(DEFAULT, 00048, 'O Processo', 'Franz Kafka', 11.94, 6, 'O Processo é um romance do escritor checo Franz Kafka, que conta a história de Josef K., que acorda certa manhã, e é preso e sujeito a longo e incompreensível processo por um crime não especificado.', 0);
