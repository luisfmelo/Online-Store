...
INSERT INTO books VALUES(DEFAULT, 'DES65478', 'Do ABC da BTT até onde puderes...', 'Mário Alpiarça', 25.00, 2, '"O "ABC da BTT até onde puderes..." é o primeiro livro, do meu conhecimento, a abordar o BTT de uma forma tão acessível, didáctica e holística para todos os amantes desta modalidade, em português, de uma forma tão rica e, acima de tudo, actual. Sejam os leitores iniciantes, entusiastas ou experientes, este livro oferece-lhes um vasto conhecimento de uma forma simples com informação pertinente quanto aos mais variados tipos de técnica existentes.', 0);
...
/*Ciência*/
INSERT INTO books VALUES(DEFAULT, 'CIE45587', 'Demografia - A Ciência da População', 'J. Manuel Nazareth', 17.99, 1, 'O terreno de jogo é o campo de batalha. Cada partida, um duelo onde aquele que comete menos erros vencerá. Como se organiza uma estratégia para vencer? Qual a táctica que permitirá derrotar o inimigo?', 0);
...
INSERT INTO books VALUES(DEFAULT, 'CIE78563', 'O Gene Egoísta', 'Richard Dawkins', 17.69, 1, 'O Gene Egoísta é o primeiro livro de Richard Dawkins, em que ele apresenta uma teoria que procura explicar a evolução das espécies na perspectiva do gene e não do organismo, ou da espécie.', 0);
INSERT INTO books VALUES(DEFAULT, 'CIE41280', 'O Erro de Descartes', 'António Damásio', 21.59, 1, 'Em "O Erro de Descartes", obra do neurologista português António Damásio, surge uma nova interpretação acerca do axioma cartesiano cogito, ergo sum. Em vez da plenitude da razão, abre-se espaço para a ética das emoções.', 0);
...
INSERT INTO books VALUES(DEFAULT, 'CIE98025', 'A Origem das Espécies', 'Charles Darwin', 21.98, 1, 'A Origem das Espécies, do naturalista britânico Charles Darwin, apresenta a Teoria da Evolução. O nome completo da primeira edição é On the Origin of Species by Means of Natural Selection.', 0);
...
INSERT INTO books VALUES(DEFAULT, 'ROM12458', 'A Cabana', 'William P. Young', 11.99, 3, 'A Cabana é um livro do escritor canadense William P. Young, lançado em 2007 nos Estados Unidos. Chegou ao Brasil pela Editora Sextante em 2008. No ano de 2009 ganhou o Diamond Awards por ter vendido 10 milhões de cópias nos EUA.', 0);
INSERT INTO books VALUES(DEFAULT, 'ROM36987', 'Cem Anos de Solidão', 'Gabriel García Márquez', 13.44, 3, 'Cem Anos de Solidão é uma obra do escritor colombiano Gabriel García Márquez, Prémio Nobel da Literatura em 1982, e é atualmente considerada uma das obras mais importantes da literatura latino-americana.', 0);
...
INSERT INTO books VALUES(DEFAULT, 'ART82436', 'O Futuro da Pintura', 'Wassily Kandinsky', 9.54, 5, 'Neste conjunto de ensaios publicados entre 1925 e 1943, Kandinsky expressa o seu pensamento sobre a pintura', 0);
...
/*Drama*/
INSERT INTO books VALUES(DEFAULT, 'DRA48163', 'A Peste', 'Albert Camus', 10.21 , 6, 'A Peste é considerada a Magnum opus de Albert Camus, publicado 1947, que conta a história de trabalhadores que descobrem a solidariedade em meio a uma peste que assola a cidade de Oran na Argelia.', 0);
...
INSERT INTO books VALUES(DEFAULT, 'DRA13567', 'Lolita', 'Vladimir Nabokov', 11.54, 6, 'Lolita é um romance de Vladimir Nabokov, escrito em inglês e publicado em 1955 em Paris, em 1958 na Cidade de Nova Iorque, e em 1959 em Londres.', 0);
INSERT INTO books VALUES(DEFAULT, 'DRA39596', 'Édipo Rei', 'Sófocles', 9.04, 6, 'Édipo Rei é uma peça de teatro grega, em particular uma tragédia, escrita por Sófocles por volta de 427 a.C.. Aristóteles, na sua Poética, considerou esta obra o mais perfeito exemplo de tragédia grega.', 0);
...
INSERT INTO books VALUES(DEFAULT, 'DRA29095', 'O Processo', 'Franz Kafka', 11.94, 6, 'O Processo é um romance do escritor checo Franz Kafka, que conta a história de Josef K., que acorda certa manhã, e é preso e sujeito a longo e incompreensível processo por um crime não especificado.', 0);
